...
public class duke1_c2_w4_PE_T7_getTotalBirthsRankedHigher {
    public static String fileName = "us_babynames/us_babynames_by_year/yob1900.csv";
...
//        int rankHighestSoFar = 1000000;
    ...
    public static double getTotalBirthsRankedHigher(int year, String name, String gender) {
        System.out.println(" ");
        return 0.0;
    }
}